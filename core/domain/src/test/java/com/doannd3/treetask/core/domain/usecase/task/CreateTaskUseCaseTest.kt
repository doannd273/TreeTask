...
class CreateTaskUseCaseTest {
    ...
    @Test
    fun `create task with empty title returns title empty error`() =
        runTest {
            val result =
                createTaskUseCase(
                    title = "  ",
    ...
    @Test
    fun `create task with empty description returns description empty error`() =
        runTest {
            val result =
                createTaskUseCase(
                    title = "Title",
    ...
    @Test
    fun `create task with empty status returns status empty error`() =
        runTest {
            val result =
                createTaskUseCase(
                    title = "Title",
    ...
    @Test
    fun `create task with invalid status returns invalid status error`() =
        runTest {
            val result =
                createTaskUseCase(
                    title = "Title",
    ...
    @Test
    fun `create task with empty due date returns due date empty error`() =
        runTest {
            val result =
                createTaskUseCase(
                    title = "Title",
    ...
    @Test
    fun `create task with invalid due date returns invalid due date error`() =
        runTest {
            val result =
                createTaskUseCase(
                    title = "Title",
    ...
    @Test
    fun `create task with valid input trims fields and calls repository`() =
        runTest {
            val task = createTask()
            coEvery {
