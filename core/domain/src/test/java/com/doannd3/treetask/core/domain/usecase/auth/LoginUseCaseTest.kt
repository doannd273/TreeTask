...
class LoginUseCaseTest {
    ...
    @Test
    fun `login with empty email returns email empty error`() = runTest {
        // WHEN
    ...
    @Test
    fun `login with empty password returns password empty error`() = runTest {
        // WHEN
    ...
    @Test
    fun `login with valid input trims email and password before calling repository`() = runTest {
        // GIVEN
        val email = "  test@treetask.com  "
        val password = "  password123  "
